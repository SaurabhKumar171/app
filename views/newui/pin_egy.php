...
function otp(){
    ...
    $.ajax({
        url:"<?php echo base_url(); ?>welcome/egy_otp_resend",
        data:dataString,
...
function submit(){
    ...
    if(otp==''){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>welcome/egy_otp_verify",
            data:dataString,
            success:function(data){
                data = data.replace(/(\r\n|\n|\r)/gm, "");
                if(data=="success"){
