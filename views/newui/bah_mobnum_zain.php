...
<footer class="page-footer font-small blue"  style="margin-top: 30px;" dir="rtl">
    <div class="footer-copyright text-center py-3">سوف تشترك في mComics عن مشتركين <?php echo $subtype; ?>. ستبدأ الاشتراك المدفوع بعد الفترة المجانية لمدة يوم واحد تلقائيًا فترة البدء المجانية للمشتركين الجدد فقط.  لإلغاء اشتراكك ، يرجى إرسال Unsub MC إلى 98726 عن مشتركين stc و 94005 عن مشتركين Zain وإلى 94466 لمشتركي بتلكو. للإلغاء من الموقع ، يرجى الانتقال إلى ملف التعريف الخاص بك ثم اضغط على زر إلغاء الاشتراك. لأية استفسارات يرجى الاتصال بنا على support@pheuture.com</div>
</footer>
<?php } ?>