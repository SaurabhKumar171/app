...
function otp(){
    ...
    if(mobnum==''){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>welcome/ken_password_resend_login",
            data:dataString,
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data=="success"){
                    ...
                    $.ajax({
                        url:"<?php echo base_url(); ?>welcome/ken_get_mobnum",
                        data:dString,
                        success:function(data){
                            data = data.replace(/(\r\n|\n|\r)/gm, "");
                            window.location.href="<?php echo base_url().'welcome/ken_home?mobnum='; ?>"+data;     
                        },
                        error: function(data) {
                            alert(a1);
                        }
