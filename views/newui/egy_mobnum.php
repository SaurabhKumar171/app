...
<script>
function checkSub(){
    window.location.href="<?php echo base_url().'welcome/egy_home?mobnum='.$mobnum; ?>";
}
...
function submit(){
    ...
    if(selOperator==''){
        ...
        window.location.href="<?php echo base_url().'welcome/egy_consent_callback?'; ?>"+dataString; 
    }  
}
</script>
<?php if($lang=="en"){ ?>
        ...
        <div id="d1">
            ...
            <div class="form-group" style="margin-top: 25px;">
                <select class="form-control" id="selOperator" name="operator">
                    ...
                    <option value="60201">Orange - EGY</option>
                    <option value="60202">Vodafone - EGY</option>
                    <option value="60204">WE - EGY</option>
                    <option value="60203">Etisalat - EGY</option>
                </select>
            </div>
...
<footer class="page-footer font-small blue"  style="margin-top: 30px;">
    <div class="footer-copyright text-center py-3">You will subscribe in mComics for <span class='bold-red'><?php echo $subtype; ?></span>.<br/>To cancel your subscription, please send Unsub MC for free to 5030 for Orange subscribers and to 2303  for Vodafone subscribers and to 4041 for WE subscribers and to 1722 for Etisalat subscribers.<br/>To cancel from the site please go to your profile then press Unsubscribe button.<br/>The internet usage will be deducted from your package knowing that the service will be renewed automatically.<br/>For any inquires please contact us on support@pheuture.com<br/>Terms and conditions apply.</div>
</footer>
<?php }else{ ?>
<div class="row">
<div class="col-md-12">
...
<footer class="page-footer font-small blue"  style="margin-top: 30px;" dir="rtl">
    <div class="footer-copyright text-center py-3">سوف تشترك في mComics لـ <span class='bold-red'><?php echo $subtype; ?></span>.<br/>لإلغاء اشتراكك ، يرجى إرسال Unsub MC مجانا إلى 5030 لمشتركي Orange وإلى 2303  لمشتركي Vodafone وإلى 4041 لمشتركي WE وإلى 1722 لمشتركي Etisalat.<br/>للإلغاء من الموقع ، يرجى الانتقال إلى ملف التعريف الخاص بك ثم الضغط على زر إلغاء الاشتراك.<br/>الانترنت سوف يخصم من الباقة الخاصة بك مع العلم ان الخدمة تجدد تلقائيا.<br/>لأية استفسارات ، يرجى الاتصال بنا على support@pheuture.com<br/>تطبق الشروط و الاحكام</div>
</footer>
<?php } ?>