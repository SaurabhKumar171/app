...
function otp(){
    ...
    if(mobnum==''){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>welcome/jor_password_resend_login",
            data:dataString,
...
function submit(){
    ...
    if(mobnum==''){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>welcome/jor_password_verify",
            data:dataString,
            success:function(data){
                data = data.replace(/(\r\n|\n|\r)/gm, "");
                if(data=="success"){
                    ...
                    $.ajax({
                        url:"<?php echo base_url(); ?>welcome/jor_get_mobnum",
                        data:dString,
                        success:function(data){
                            data = data.replace(/(\r\n|\n|\r)/gm, "");
                            window.location.href="<?php echo base_url().'welcome/jor_home?mobnum='; ?>"+data;     
                        },
                        error: function(data) {
                            alert(a1);
                        }
