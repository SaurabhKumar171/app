...
<div class="col-md-4"></div>
<div class="col-md-4">
<a class="sub-btn" href="<?php echo base_url();?>welcome/pa_unsub"><button type="button" class="form-control subscribe_btn" onclick="submit()"><b>Yes</b></button></a>
</div>
</div>
</div>
...
<div class="col-md-4"></div>
<div class="col-md-4">
<a class="sub-btn" href="<?php echo base_url();?>welcome/pa_unsub"><button type="button" class="form-control subscribe_btn" onclick="submit()"><b>نعم</b></button></a>
</div>
</div>
</div>
