<script>
/*function checkSub(){
    window.location.href="<?php echo base_url().'welcome/om_home?mobnum='.$mobnum; ?>";
}*/
...
function submit(){
    ...
    if(selOperator==''){
        ...
        window.location.href="<?php echo base_url().'welcome/om_consent_callback?'; ?>"+dataString; 
    }  
}
</script>
<body>
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <select class="form-control" id="selOperator" name="selOperator">
            <option value="42203">Ooredoo - Oman</option>
        </select>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-4">
            <div class="left-inner-addon ">
                ...
                <input maxlength="11" value="" type="tel" id="mobnum" name="mobnum" class="form-control" onblur="this.placeholder = 'ex. 968xxxxxxxx'" onfocus="this.placeholder = ''" placeholder="ex. 968xxxxxxxx" autocomplete="off" />
            </div>
        </div>
    </div>
</div>
