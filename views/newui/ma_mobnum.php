...
function submit(){
    ...
    if(lang=="en"){
        ...
        a1 = "Veuillez sélectionner l'opérateur";
        a2 = "Veuillez entrer le numéro";
        a3 = "Veuillez saisir un numéro valide";
    }
    else{
    ...
    if(selOperator==''){
        ...
        window.location.href="<?php echo base_url().'welcome/ma_consent_callback?'; ?>"+dataString; 
    }  
}
</script>
<body>
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <select class="form-control" id="selOperator" name="selOperator">
            <option value="60902">Chinguitel - Mauritania</option>
        </select>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-4">
            <div class="left-inner-addon ">
                ...
                <input maxlength="11" value="" type="tel" id="mobnum" name="mobnum" class="form-control" onblur="this.placeholder = 'ex. 2222xxxxxxx'" onfocus="this.placeholder = ''" placeholder="ex. 2222xxxxxxx" autocomplete="off" />
            </div>
        </div>
    </div>
</div>
...
<div class="col-md-4"></div>
<div class="col-md-4">
<button type="button" class="form-control subscribe_btn" onclick="submit()"><b>Obtenir l'épingle</b></button>
</div>
</div>
</div>
...
<div class="col-md-4"></div>
<div class="col-md-4">
<button type="button" class="form-control subscribe_btn" onclick="submit()"><b>احصل على رمز التحقق</b></button>
</div>
</div>
</div>
