...
function otp(){
    ...
    $.ajax({
        url:"<?php echo base_url(); ?>welcome/jor_otp_resend",
        data:dataString,
...
function submit(){
    ...
    if(otp==''){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>welcome/om_otp_verify",
            data:dataString,
            success:function(data){
                console.log(data);
                data = data.replace(/(\r\n|\n|\r)/gm, "");
...
<div class="col-md-4"></div>
<div class="col-md-4">
<button type="button" class="form-control subscribe_btn" onclick="submit()"><b>يتأكد</b></button>
</div>
</div>
</div>
