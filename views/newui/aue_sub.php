...
<?php } ?>
<div class="register" id="main1en" style="display: none;" >
...
<div class="container">
    <form id="signupForm" style="margin-top: 50px;">
        ...
        <div class="row">
          <div class="col-md-4"></div>
          <div class="col-md-4">
            <center><p style="padding-top: 12px;"><b>Welcome to mToon. As a subscription, you will be charged 3.25 AED / day.</b></p></center>
          </div>
          <div class="col-md-4"></div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="left-inner-addon ">
                        ...
                        <input maxlength="9" value="<?php if(isset($_SESSION['mobnum'])){ echo $_SESSION['mobnum'];} ?>" type="tel" id="mobnum_en" name="mobnum_pj" class="form-control" onblur="this.placeholder = '5xxxxxxxx'" onfocus="this.placeholder = ''" placeholder="5xxxxxxxx" autocomplete="off" />
                    </div>
                </div>
            </div>
        </div>
...
<div class="container">
    <form id="signupForm" style="margin-top: 50px;">
        <div class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
            <center><div style="display: none;" class="alert alert-danger" role="alert" id="showerror_msg_ar">
            </div></center>
            </div>
            <div class="col-md-4"></div>
        </div>
        <div class="row">
          <div class="col-md-4"></div>
          <div class="col-md-4">
            <center><p style="padding-top: 12px;" dir="rtl"><b>مرحبا بكم في كاريكاتير. كاشتراك ، سيتم محاسبتك 3.25 درهم / اليوم</b></p></center>
          </div>
          <div class="col-md-4"></div>
        </div>
        <div style="margin-top:0px;"></div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="left-inner-addon ">
                        <span class="countryCode">971-</span>
                        <input maxlength="9" value="<?php if(isset($_SESSION['mobnum'])){ echo $_SESSION['mobnum'];} ?>" type="tel" id="mobnum_ar" name="mobnum_pj" class="form-control" onblur="this.placeholder = '5xxxxxxxx'" onfocus="this.placeholder = ''" placeholder="5xxxxxxxx" autocomplete="off" />
                    </div>
                </div>
            </div>
        </div>
...
$(".nextbtn_pj").click(function(e){
    ...
    e.stopPropagation(); 
    var lang = $("#lang").val();
    var a1,a2,mob,mob_field,err_msg;
    if(lang=="ar"){
        a1 = "الرجاء إدخال الرقم!";
        a2 = "الرجاء إدخال الرقم الصحيح!";
        mob_field = 'mobnum_ar';
        err_msg = 'showerror_msg_ar';
        mob=$('#'+mob_field).val();
    }
    else{
        a1 = "Please enter the number!";
        a2 = "Please enter the correct number!";
        mob_field = 'mobnum_en';
    ...
    if(mob==""){
        ...
        $("#"+err_msg).show();
        $('#'+mob_field).focus();
        $('#'+mob_field).css("border-color", "red");
        $("#"+err_msg).html(a1);
        setTimeout(function(){
            $("#"+err_msg).hide();
            $('#'+mob_field).css("border-color", "");           
        }, 5000);
        return false;
    }
        ...
        console.log("reach4");
        window.location.href="http://u.mtoonapp.com/aue_otp?mobnum="+mob+"&lang="+lang;
    }
});
...
jQuery(document).ready(function($){ 
    ...
    /*$("#tc").click(function(){
      ...
      var lang = $("#lang").val();
      alert(lang);
      console.log("<?php echo base_url();?>welcome/sendEUOTP/"+lang);
      window.location = "<?php echo base_url();?>welcome/sendEUOTP/"+lang;
  });*/

  $("#tc_en").click(function(){
      $("#tc_en").css("display", "none");
      window.location = "<?php echo base_url();?>welcome/sendEUOTP/en";
  });

  $("#tc_ar").click(function(){
      $("#tc_ar").css("display", "none");
      window.location = "<?php echo base_url();?>welcome/sendEUOTP/ar";
  });
