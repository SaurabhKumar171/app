...
function otp(){
    ...
    if(lang=="en"){
        ...
        a3 = "Veuillez entrer le nom d'utilisateur";
        a4 = "Ce nom d'utilisateur n'existe pas. Vérifiez s'il vous plaît.";
    }
    else{
    ...
    if(mobnum==''){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>welcome/ma_password_resend_login",
            data:dataString,
...
function submit(){
    ...
    if(lang=="en"){
        ...
        a1 = "Il y a eu une erreur. Veuillez réessayer.";
        a2 = "Veuillez entrer le mot de passe";
        a3 = "Veuillez entrer le nom d'utilisateur";
        a4 = "Mot de passe incorrect. Veuillez réessayer.";
    }
    else{
        a1 = "كان هناك بعض الخطأ. حاول مرة اخرى.";
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data=="success"){
                    ...
                    $.ajax({
                        url:"<?php echo base_url(); ?>welcome/ma_get_mobnum",
                        data:dString,
                        success:function(data){
                            data = data.replace(/(\r\n|\n|\r)/gm, "");
                            window.location.href="<?php echo base_url().'welcome/ma_home?mobnum='; ?>"+data;     
                        },
                        error: function(data) {
                            alert(a1);
                        }
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-4">
            <div class="left-inner-addon ">
                <input type='text' class="form-control" id="mobnum" placeholder="Saisissez votre nom d'utilisateur" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength='12'/>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-4">
            <div class="left-inner-addon ">
                <input type='text' class="form-control" id="pin" placeholder="Entrer le mot de passe" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength='6' />
            </div>
        </div>
    </div>
</div>
...
<div class="col-md-4"></div>
<div class="col-md-4">
<button type="button" class="form-control subscribe_btn" onclick="submit()"><b>Nous faire parvenir</b></button>
</div>
</div>
</div>
...
<div style="height: 50px;"></div>
</div> <!-- End of  French section container -->
<?php }else{ ?>
