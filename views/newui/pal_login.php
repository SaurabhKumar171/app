...
function otp(){
    ...
    if(mobnum==''){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>welcome/pal_password_resend_login",
            data:dataString,
...
function submit(){
    ...
    if(mobnum==''){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>welcome/pal_password_verify",
            data:dataString,
            success:function(data){
                data = data.replace(/(\r\n|\n|\r)/gm, "");
                if(data=="success"){
                    ...
                    $.ajax({
                        url:"<?php echo base_url(); ?>welcome/pal_get_mobnum",
                        data:dString,
                        success:function(data){
                            data = data.replace(/(\r\n|\n|\r)/gm, "");
                            window.location.href="<?php echo base_url().'welcome/pa_home?mobnum='; ?>"+data;     
                        },
                        error: function(data) {
                            alert(a1);
                        }
